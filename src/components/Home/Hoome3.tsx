  ...
  return (
    <section className='px-12 py-[84px] flex flex-col gap-12'>
        ...
        <div className='flex flex-col gap-7 items-center'>
            ...
            <Link href="/products"><button className='bg-black rounded-full text-white text-[15px] leading-6 text-center font-[500] w-[138px] h-[39px]'>Find Your Product</button></Link>
        </div>
    </section>
  )
}
